...
const Schema: z.ZodType<Prisma.billingsCreateNestedManyWithoutProviderInput> = z
  .object({
    create: z
      .union([
...
export const billingsCreateNestedManyWithoutProviderInputObjectSchema = Schema;
