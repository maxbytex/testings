...
const Schema: z.ZodType<Prisma.providersUncheckedUpdateWithoutSpecializationInput> =
  z
    .object({
      id: z
        .union([
...
export const providersUncheckedUpdateWithoutSpecializationInputObjectSchema =
  Schema;
