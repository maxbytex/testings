...
const Schema: z.ZodType<Prisma.providersUncheckedCreateNestedManyWithoutSpecializationInput> =
  z
    .object({
      create: z
        .union([
...
export const providersUncheckedCreateNestedManyWithoutSpecializationInputObjectSchema =
  Schema;
