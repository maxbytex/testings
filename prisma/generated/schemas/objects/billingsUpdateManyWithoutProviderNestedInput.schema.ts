...
const Schema: z.ZodType<Prisma.billingsUpdateManyWithoutProviderNestedInput> = z
  .object({
    create: z
      .union([
...
export const billingsUpdateManyWithoutProviderNestedInputObjectSchema = Schema;
