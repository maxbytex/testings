...
const Schema: z.ZodType<Prisma.providersUpdateManyWithoutSpecializationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const providersUpdateManyWithoutSpecializationNestedInputObjectSchema =
  Schema;
