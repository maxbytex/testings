...
const Schema: z.ZodType<Prisma.providersUncheckedCreateWithoutBillingsInput> = z
  .object({
...
export const providersUncheckedCreateWithoutBillingsInputObjectSchema = Schema;
